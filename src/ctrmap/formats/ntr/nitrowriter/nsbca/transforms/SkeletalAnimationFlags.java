...
public class SkeletalAnimationFlags {
	public static final int TRANSFORM_IDENTITY = (1 << 0);
	
	public static final int TRANSFORM_IDENTITY_T = (1 << 1);
